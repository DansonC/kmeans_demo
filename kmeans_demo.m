...
addpath('conv');
CIFAR_DIR='/Users/Calvin/Github/Neural-Networks/conv/cifar-10-batches-mat';
...
options.lambda = k_means_variance(patches, centroids, inds);
W = regression(0, patches', inds, 0, 0, options);
    
show_centroids(centroids, rfSize); drawnow;

% extract training features
if (whitening)
  trainXC = extract_features(trainX, centroids, rfSize, CIFAR_DIM, M,P, W);
else
...
if (whitening)
  testXC = extract_features(testX, centroids, rfSize, CIFAR_DIM, M, P, W);
else
